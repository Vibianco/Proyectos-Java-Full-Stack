...
function start() {
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_1()">Decides volver a casa</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_2()">Decides esperar</button>`
}

function opc_finish(){
  historia.innerHTML = `<h3 class="text-center">¡Muchas gracias por jugar!</h3>
  <div style="width:100%;height:0;padding-bottom:40%;position:relative;"><iframe src="https://giphy.com/embed/10dvjmLNHQ6O3e" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p class="text-center"><a href="https://giphy.com/gifs/nintendo-thank-you-satoru-iwata-10dvjmLNHQ6O3e">via GIPHY</a></p>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="start()">Comenzar de nuevo</button>`
}
...
function opc_1(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_4()">sigues hacia el rancho</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_5()">vuelves a entrar en la cueva</button>
  `}function opc_2(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_3()">buscas refugio</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_11()">decides soportar el viento para ver lo que hay a tu alrededor</button>
  `}function opc_3(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_16()">aceptas volver a caballo al castillo</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_86()">rechazas la invitación e intentas volver a la Cueva del Tiempo</button>
  `}function opc_4(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_12()">entras en la cueva</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_13()">sigues andando</button>
  <p></p>
  `}function opc_5(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_14()">tomas el túnel de la izquierda</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_47()">tomas el túnel de la derecha</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_15()">vuelves a salir de la cueva</button>
  `}function opc_6(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_7()">saltas</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_8()">no saltas</button>
  `}function opc_7(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_51()">aceptas</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_57()">decides seguir viajando</button>
  `}function opc_8(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_9()">montas en el caballo y sales a galope</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_10()">pides refugio al rey</button>
  `}function opc_9(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_finish()">Fin</button>
  `}function opc_10(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_17()">entras en el pasaje de la izquierda</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_18()">entras en el pasaje de la derecha</button>
  `}function opc_12(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_19()">te quedas y tratas de entablar amistad</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_20()">tratas de escapar</button>
  `}function opc_13(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_21()">saltas sobre el mamut</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_22()">sigues a pie</button>
  `}function opc_14(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_71()">Continúa...</button>
  `}function opc_15(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_25()">sigues el de la derecha</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_26()">sigues el de la izquierda</button>
  `}function opc_16(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_27()">afirmas que estás diciendo la verdad</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_28()">tratas de inventar una historia más verosímil</button>
  `}function opc_17(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_29()">te escondes para no ser visto</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_30()">te diriges a la nave espacial</button>
  <p></p>
  `}function opc_18(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_32()">le dices que deseas volver a tu época para estar con tu familia y tus amigos</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_31()">dices que no quieres correr el riesgo de ir a parar a una mala época</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_33()">le dices que te gustaría conocer otra época, pero sólo si te garantiza que podrás volver a la tuya</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_34()">le preguntas quién es</button>
  `}function opc_19(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_35()">vas con la gente de la cueva</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_36()">intentas volver a la Cueva del Tiempo</button>
  `}function opc_20(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_39()">Continúa...</button>
  `}function opc_21(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_40()">saltas</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_41()">sigues agarrado</button>
  `}function opc_22(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_42()">escoges el primer túnel</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_70()">sigues alguno de los otros túneles</button>
  `}function opc_23(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_45()">intentas bucear por el pasaje submarino</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_50()">decides esperar</button>
  `}function opc_25(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_52()">intentas encontrar al capitán para advertirle que el barco está a punto de hundirse</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_58()">vuelves a bajar por la escalera para retornar a la Cueva del Tiempo</button>
  `}function opc_26(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_56()">tratas de ayudar a Luisa a buscar el lugar por donde entró en la cueva</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_59()">le propones que vaya contigo por alguno de los túneles a fin de encontrar una salida</button>
  `}function opc_27(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_6()">Continúa...</button>
  `}function opc_28(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_61()">te diriges a los constructores de la muralla</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_66()">vuelves a la grieta</button>
  `}function opc_30(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_87()">lo haces</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_62()">no lo haces</button>
  `}function opc_31(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_37()">corres hacia la cueva</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_38()">te dispones a luchar</button>
  `}function opc_37(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_18()">Continúa...</button>
  `}function opc_38(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_60()">Continúa...</button>
  `}function opc_39(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_72()">subes al tren</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_74()">vas a la granja</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_76()">vuelves al túnel con la esperanza de encontrar el camino hacia tu época</button>
  <p></p>
  `}function opc_43(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_44()">te quedas en la “sociedad perfecta”</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_46()">intentas volver a la Cueva del Tiempo</button>
  `}function opc_44(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_48()">te quedas con tus nuevos amigos</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_49()">viajas hacia el interior</button>
  `}function opc_46(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_79()">le dices que vienes del futuro</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_80()">intentas idear una historia más creíble</button>
  `}function opc_48(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_77()">Continúa...</button>
  `}function opc_51(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_53()">lo intentas</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_55()">no lo intentas</button>
  `}function opc_52(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_54()">decides abrir el huevo</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_78()">lo guardas en tu armario con la intención de consultar con un científico</button>
  `}function opc_54(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_65()">exploras el pasadizo</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_67()">decides volver a explorar la salida de la cueva</button>
  `}function opc_59(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_64()">te quedas y tratas de entablar amistad con las gentes primitivas</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_63()">vuelves a la colina intentando entrar de nuevo en la Cueva del Tiempo</button>
  `}function opc_63(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_68()">vuelves a la cueva</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_69()">te quedas fuera</button>
  `}function opc_68(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_43()">Continúa...</button>
  `}function opc_71(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_23()">sigues el primer túnel</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_24()">sigues un túnel más lejano</button>
  `}function opc_72(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_73()">te quedas hasta Gettysburg</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_75()">bajas en Parkersville</button>
  `}function opc_73(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_finish()">Fin</button>
  `}function opc_74(){
  historia.innerHTML = `<button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_()">subes al tren puedes perder la oportunidad de volver a la Cueva del Tiempo. Es mejor permanecer cerca del túnel. Decides que, en cualquier caso, pensarás con más claridad después de haber comido algo</button>
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_81()">decides quedarte en casa y seguir trabajando con el tío Ted</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_82()">decides contratarte como aprendiz en la imprenta del señor Nelson</button>
  `}function opc_80(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_83()">tratas de escapar</button>
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_85()">le dices que eres inocente</button>
  `}function opc_81(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_84()">Continúa...</button>
  `}function opc_84(){
  ...
  <button class="btn btn-outline-dark btn-lg btn-block" onclick="opc_47()">Continúa...</button>
  `}function opc_87(){
